    ...
    <header class="bg-white border-b border-gray-200 shadow-sm">
      <div class="max-w-7xl mx-auto px-4 py-6">
        <div class="flex items-center justify-between mb-4">
          <button
            class="inline-flex items-center gap-2 text-gray-600 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2 rounded-lg px-2 py-1"
    ...
    <main id="main-content" class="max-w-7xl mx-auto px-4 py-12" tabindex="-1">
      ...
      <section class="mb-12">
        <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
          <span class="flex items-center justify-center w-10 h-10 bg-green-100 rounded-lg">
        ...
        <div class="grid md:grid-cols-2 gap-6">
          ...
          >
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ t(feature.title) }}</h3>
                <p class="text-gray-600 mb-3">{{ t(feature.description) }}</p>
      ...
      <section class="mb-12">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            ...
            :key="feature.title"
            class="bg-white rounded-xl p-6 border-2 border-dashed border-primary-200 hover:border-primary-400 transition-colors"
          >
            <div class="flex items-start gap-4 mb-4">
              ...
              <div class="flex-1">
                ...
                <h3 class="text-lg font-semibold text-gray-900">{{ t(feature.title) }}</h3>
              </div>
            </div>
            <p class="text-gray-600 mb-4">{{ t(feature.description) }}</p>
            <ul class="space-y-2">
              <li
            ...
            <ul class="space-y-3">
              <li v-for="tech in stack.items" :key="tech.name" class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div class="text-sm text-gray-500">{{ tech.purpose }}</div>
                </div>
              </li>
            </ul>
          </div>
      ...
      <section class="bg-amber-50 border-2 border-amber-200 rounded-xl p-8">
        <div class="flex items-start gap-4">
          ...
          <div>
            <h3 class="text-xl font-bold text-gray-900 mb-3">{{ t('roadmap.privacyTitle') }}</h3>
