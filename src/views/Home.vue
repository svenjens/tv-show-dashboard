      ...
      <div class="relative max-w-7xl mx-auto px-4 py-12">
        <div class="flex justify-between items-start mb-6">
          ...
          <div class="flex items-center gap-4">
            ...
            <!-- AI Roadmap Link -->
            <router-link
              :to="{ name: 'roadmap', params: { locale: route.params.locale || 'en' } }"
              class="inline-flex items-center gap-2 text-white hover:text-primary-200 transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600 rounded-lg px-3 py-2"
